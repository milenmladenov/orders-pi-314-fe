                    ...
                    {groupForms.map((formData, index) => (
                        <div>
                            <div key={index} className="grid grid-cols-1 md:grid-cols-1 gap-2 cols-span-3">
                                ...
                                <form
                                    id={`orderForm${index}`}
                                    className="grid grid-cols-6 gap-4 border"
                                    style={{ padding: '20px', width: '1300px' }}
                                >
                                    <div>
                                        <label htmlFor="doorName" className="block font-medium">Материал:</label>
                                        <select className="mt-1 w-full p-2 border rounded-md shadow-sm"
                                    ...
                                    {/* Model Name */}
                                    <div>
                                        <label htmlFor={`modelName${index}`} className="block font-medium">Модел:</label>
                                        <select className="mt-1 w-full p-2 border rounded-md shadow-sm"
                                            id={`modelName${index}`}
                                            name={`modelName${index}`}
                                            value={formData['Модел']}
                                            onChange={(event) => handleChange(event, index)}
...
*/}
                                        ...
                                        <select className="mt-1 w-full p-2 border rounded-md shadow-sm"
                                            id="folioName"
                                            name="folioName"
                                            value={formData['Фолио']}
                                            onChange={(event) => handleChange(event, index)}
                                            disabled={groupForms.modelName === ''}
                                            required
                                        >
                                            <option value="" selected="selected">Фолио</option>
